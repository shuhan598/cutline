...
from app.schemas.result_schema import NetRateResult, OverflowTimeResult
...
class OverflowTimeCalculator:
    ...
    def calculate(
        ...
        for net_rate in net_rates:
            ...
            consume = abs(net_rate_per_hour)
            overflow_minutes = (
                (capacity - inventory) / consume * 60 if consume > 0 else None
            )
